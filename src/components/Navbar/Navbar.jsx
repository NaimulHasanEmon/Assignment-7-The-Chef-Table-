        ...
        <div>
            <div className="navbar bg-base-100 relative z-10">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-lg md:text-xl lg:text-xl restaurant-title">Recipe Calories</a>
                </div>
                    ...
                    <div className="flex gap-1 md:gap-2 lg:gap-2">
                        <div className="form-control">
                            <input
                                type="text"
                                placeholder="Search"
                                className="text-xs md:text-sm lg:text-sm input input-bordered h-7 w-[75px] md:h-8 md:w-auto lg:h-8 lg:w-24 rounded-3xl"
                            />
                        </div>
                        <div>
